export default function About() {
  return <section id="about" className="section">
    <div className="section-head"><span className="section-title">01 — professional experience</span></div>
    <div className="experience-list">
      <article className="experience-item">
        <span className="experience-dot" aria-hidden="true" />
        <div className="experience-heading">
          <div><h3>Intern – HR Department</h3></div>
          <div className="experience-meta"><span>LGU – Agoo | Agoo, La Union</span><time>February 2026 – May 2026</time></div>
        </div>
      ...
      <article className="experience-item">
        ...
        <div className="experience-heading">
          ...
          <div className="experience-meta"><span>Universidad de Dagupan | Dagupan, Pangasinan</span><time>May 2025 – December 2025</time></div>
        </div>
